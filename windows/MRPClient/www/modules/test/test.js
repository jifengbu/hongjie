define(function(require) {
    ...
    Test.prototype.release = function() {
		app.utils.setReleasePanel(null);
    };
	Test.prototype.onLoad = function() {
    };
    Test.prototype.doTestWeixinLink = function() {
        var param = {
...
//        var url = "http://58.251.15.147/"+"?"+ $.param(param);
    ...
    Test.prototype.doTestWeixinSendMsg = function() {
        var param = {
...
//        var url = "http://192.168.211.248:3000/test/"+"?"+ $.param(param);
    ...
    Test.prototype.onSuccess = function(data) {
        console.log(data);
        app.utils.clearWait();
        $('#test_list').html(data);
    };

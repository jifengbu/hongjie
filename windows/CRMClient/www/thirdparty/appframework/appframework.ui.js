...
(function ($) {
    ...
    var popup = (function () {
        ...
        popup.prototype = {
            ...
            positionPopup: function () {
                ...
                if (_os == "windows" && $.query(".iphone_screen").get(0)) {
                    popup.css("top", ((window.innerHeight*0.7164 / 2.5) + window.pageYOffset) - (popup[0].clientHeight / 2) + "px");
                    popup.css("left", (window.innerWidth*0.8602 / 2) - (popup[0].clientWidth / 2) + "px");
                } else {
    ...
    $.blockUI = function (opacity) {
        if (uiBlocked)
            return;
        if (_os == "windows"  && $.query(".iphone_screen").get(0)) {
            opacity = opacity ? " style='opacity:" + opacity + ";position: inherit;'" : "";
